...
## Installation and Setup
   ...
   > For the Argonne tutorial, the SDK is already installed at `<INSERT PATH>`. Add this location
   > to your `PATH` with `export PATH=$PATH:<INSERT PATH>`.
...
For convenience, this repository contains a small example program for running the SDK simulator.
This and more example programs can be found on ALCF at `<INSERT PATH>`
